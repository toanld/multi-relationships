...
namespace Toanld\Relationship\Database\Eloquent\Concerns;

use Toanld\Relationship\Database\Eloquent\Relations\BelongsTo;
use Toanld\Relationship\Database\Eloquent\Relations\HasMany;
use Toanld\Relationship\Database\Eloquent\Relations\HasOne;
use Toanld\Relationship\Exceptions\InvalidUsageException;
...
trait HasRelationships
{
     ...
     * @param string|array|null $localKey (ưu tiên từ trái sang phải)
     *
     * @return \Toanld\Relationships\Database\Eloquent\Relations\HasOne
     */
    ...
    /**
     * Validate the related model for Relationships compatibility.
     *
     * @param $related
     *
    ...
    {
        $traitClass = Relationships::class;
     ...
     *
     * @return \Toanld\Relationships\Database\Eloquent\Relations\HasMany
     */
     ...
     *
     * @return \Toanld\Relationships\Database\Eloquent\Relations\BelongsTo
     */
